<template>
	<div id="app">
		...
		<hr>
		<p v-destaque-local.atrasar="{cor1: 'lightgreen', atraso: 5000}">Usando diretiva personalizada</p>
		<p v-destaque-local:fundo.atrasar.alternar="{cor1: 'lightgreen', cor2:'lightblue', atraso: 2000, intervalo: 200}">Usando diretiva personalizada</p>
	</div>
</template>
