		...
		<div class="conteudo">
			<form class="painel" v-if="!envido">
				...
				<Rotulo nome="Armazenar Dados">
					<span class="mr-4"><input type="radio" value="sim" v-model="armazenarDados"> Sim</span>
					<span class="mr-4"><input type="radio" value="não" v-model="armazenarDados"> Não</span>
				</Rotulo>
				<!-- Exercicio 02 -->
